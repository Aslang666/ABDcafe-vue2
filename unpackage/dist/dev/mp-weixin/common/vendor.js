...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__EDA5656",
    appName: "ABDcafe（vue2)",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
var addCart = function addCart(cart_items) {
  return (0, _request.request)({
    url: "/api/cart/cart/",
    headers: {
      "Authorization": 'Bearer ' + uni.getStorageSync('access')
...
var updateAddr = function updateAddr(addresses) {
  return (0, _request.request)({
    url: "/api/accounts/info/",
    headers: {
      "Authorization": 'Bearer ' + uni.getStorageSync('access')
...
var addAddr = function addAddr(addresses) {
  return (0, _request.request)({
    url: "/api/accounts/info/",
    headers: {
      "Authorization": 'Bearer ' + uni.getStorageSync('access')
...
var delAddr = function delAddr(addresses) {
  return (0, _request.request)({
    url: "/api/accounts/info/",
    headers: {
      "Authorization": 'Bearer ' + uni.getStorageSync('access')
